...
public class UserMapper implements RowMapper<UserModel> {
	...
	public UserModel mapRow(ResultSet resultSet) {
		try {
			 ...
			 * users.setCreatedBy(resultSet.getString("createdby")); if
			 * (resultSet.getTimestamp("modifieddate") != null) {
			 * users.setModifiedDate(resultSet.getTimestamp("modifieddate")); } if
			 * (resultSet.getString("modifiedby") != null) {
